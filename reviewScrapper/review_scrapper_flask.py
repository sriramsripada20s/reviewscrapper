...
app = Flask(__name__)  # initialising the flask application with the name 'app'
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                for commentbox in commentboxes:
                    ...
                    try:
                        ...
                        custComment = comtag[0].div.text  #Entire customer comment is stored here
                    except:
...
if __name__ == "__main__":
    app.run(port=8000,debug=True) # running the app on the local machine on port 8000 #whenever application runs for 1st time it searches for main method